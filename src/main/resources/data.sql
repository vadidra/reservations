...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C2'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Young'), '2020-10-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C3'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Cox'), '2020-10-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'M1'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Cruz'), '2020-10-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'M3'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Bell'), '2020-10-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'P1'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Black'), '2020-10-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'W1'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Willis'), '2020-10-01');
